...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar pa�s por el nombre del atleta");
	 ...
	 * país en ese evento.
	 */
	private void ejecutarPaisPorNombre()
	{
		System.out.println("\n"+"Pa�s de un atleta dado "+"\n");
		String atleta = input("Por favor ingrese el nombre del atleta");
		String Pais = calculadora.paisPorAtleta(atleta).darNombre();
		System.out.println("El pa�s del atleta "+atleta+" es: ");
